  ...
  return (
    <>
      ...
      <div className="relative">
        <div className="fixed bottom-0 right-0 inline-block w-10 mr-10 align-middle transition duration-200 ease-in select-none">
          ...
          <label
            ...
            } toggle-label block mb-10 overflow-hidden h-6 rounded-full bg-gray-300 cursor-pointer text-white`}
          ></label>
        </div>
        <Header />
        <main>{children}</main>
