  ...
  return (
    <div>
      <div
        ...
        className="p-5 text-center border-2 rounded-lg "
      >
        <Image
        ...
        <div className="items-center w-40 mx-auto mt-5 transition duration-300 ease-in transform bg-white border-2 rounded-md hover:bg-gray-200 hover:border-transparent">
          <Link href={`/course/${slug}`}>
            <p className="p-5">Learn more...</p>
          </Link>
        </div>
      </div>
    </div>
